...
const SIDEBAR_WIDTH_DEFAULT = '212px'
...
const SidebarProvider = React.forwardRef(
  (
    ...
    const sidebarWidth = width || SIDEBAR_WIDTH_DEFAULT
  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
        style={{
          '--sidebar-width': sidebarWidth || SIDEBAR_WIDTH_DEFAULT,
        }}
      >
...
const SidebarMenuSkeleton = React.forwardRef(({ className, showIcon = false, ...props }, ref) => {
  ...
  const width = '70%' // static width to avoid impure Math.random
